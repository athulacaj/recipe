...
var recipeRepository = new recipeRepository_1.default();
...
var resolvers = {
    allRecipes: function (parent, _a) {
        var _b = _a.page, page = _b === void 0 ? 0 : _b, _c = _a.limit, limit = _c === void 0 ? 10 : _c;
        return recipeRepository.getAllRecipe({}, { ingredients: true }, page * limit, limit);
    },
    addRecipe: function (_a, req) {
        var name = _a.name;
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_b) {
                console.log("name ", name);
                console.log("req ", req.user);
                return [2 /*return*/, { "recipe_id": '2323434sa' }];
            });
        });
    }
};
